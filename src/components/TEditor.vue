...
import 'tinymce/plugins/wordcount';
  ...
  const props = defineProps({
    ...
    plugins: {
      type: [String, Array],
      default: "codesample preview searchreplace autolink directionality visualblocks visualchars image link media template table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount autosave"
    },//必填
    toolbar: {
      type: [String, Array],
    //   default:
    //   "undo redo  | bold italic underline | fontselect fontsizeselect | forecolor backcolor | alignleft aligncenter alignright alignjustify | bdmap indent2em lineheight formatpainter axupimgs  image letterspacing| media| searchreplace  | bullist numlist | ",
      default:
